...
def mean_(x, dimension, track_types = False, **kwargs):
  ...
  if track_types:
    ...
    out.promote_value_type(x, func = "mean", manual = manual)
  return out
...
def product_(x, dimension, track_types = False, **kwargs):
  ...
  if track_types:
    manual = TYPE_PROMOTION_TEMPLATES["numerical_reducers"]
    out.promote_value_type(x, func = "product", manual = manual)
  return out
...
def standard_deviation_(x, dimension, track_types = False, **kwargs):
  ...
  if track_types:
    manual = TYPE_PROMOTION_TEMPLATES["numerical_reducers"]
    out.promote_value_type(x, func = "standard_deviation", manual = manual)
  return out
...
def sum_(x, dimension, track_types = False, **kwargs):
  ...
  if track_types:
    manual = TYPE_PROMOTION_TEMPLATES["numerical_reducers"]
    out.promote_value_type(x, func = "sum", manual = manual)
  return out
...
def variance_(x, dimension, track_types = False, **kwargs):
  ...
  if track_types:
    manual = TYPE_PROMOTION_TEMPLATES["numerical_reducers"]
    out.promote_value_type(x, func = "variance", manual = manual)
  return out
...
def all_(x, dimension, track_types = False, **kwargs):
  ...
  if track_types:
    ...
    out.promote_value_type(x, func = "all", manual = manual)
  return out
...
def any_(x, dimension, track_types = False, **kwargs):
  ...
  if track_types:
    manual = TYPE_PROMOTION_TEMPLATES["boolean_reducers"]
    out.promote_value_type(x, func = "any", manual = manual)
  return out
...
def count_(x, dimension, track_types = False, **kwargs):
  ...
  if track_types:
    ...
    out.promote_value_type(x, func = "count", manual = manual)
  return out
...
def percentage_(x, dimension, track_types = False, **kwargs):
  ...
  if track_types:
    manual = TYPE_PROMOTION_TEMPLATES["count_reducers"]
    out.promote_value_type(x, func = "percentage", manual = manual)
  return out
...
def max_(x, dimension, track_types = False, **kwargs):
  ...
  if track_types:
    ...
    out.promote_value_type(x, func = "max", manual = manual)
  return out
...
def median_(x, dimension, track_types = False, **kwargs):
  ...
  if track_types:
    manual = TYPE_PROMOTION_TEMPLATES["ordered_reducers"]
    out.promote_value_type(x, func = "median", manual = manual)
  return out
...
def min_(x, dimension, track_types = False, **kwargs):
  ...
  if track_types:
    manual = TYPE_PROMOTION_TEMPLATES["ordered_reducers"]
    out.promote_value_type(x, func = "min", manual = manual)
  return out
...
def first_(x, dimension, track_types = False, **kwargs):
  ...
  if track_types:
    ...
    out.promote_value_type(x, func = "first", manual = manual)
  return out
...
def last_(x, dimension, track_types = False, **kwargs):
  ...
  if track_types:
    manual = TYPE_PROMOTION_TEMPLATES["universal_reducers"]
    out.promote_value_type(x, func = "last", manual = manual)
  return out
...
def mode_(x, dimension, track_types = False, **kwargs):
  ...
  if track_types:
    manual = TYPE_PROMOTION_TEMPLATES["universal_reducers"]
    out.promote_value_type(x, func = "mode", manual = manual)
  return out